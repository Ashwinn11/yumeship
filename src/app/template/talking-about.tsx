...
const sl = StyleSheet.create({
  wrap:    { gap: 2 },
  label:   { fontFamily: FontFamily.markerBold, fontWeight: '600', fontSize: 10, color: INK, textAlign: 'center' },
...
const dc = StyleSheet.create({
  ...
  hint:      { fontFamily: FontFamily.script, fontSize: 16, color: INK, opacity: 0.6 },
  ...
  clearText: { fontFamily: FontFamily.marker, fontSize: 8, color: INK },
  ...
  editBadgeText: { fontFamily: FontFamily.marker, fontSize: 8, color: INK },
});
...
const s = StyleSheet.create({
  ...
  eyebrow:   { fontFamily: FontFamily.marker, fontWeight: '600', fontSize: 9, color: INK + '88', letterSpacing: 1.6 },
  title:     { fontFamily: FontFamily.displayItalic, fontSize: 32, color: INK, letterSpacing: -1, lineHeight: 34, marginTop: 2 },
  ...
  subItems:  { marginLeft: 16, fontFamily: FontFamily.script, fontSize: 13, color: INK + '88', lineHeight: 14, marginTop: 2 },
  doodleWrap:{ width: '100%', height: 130, position: 'relative' },
  blobText:  { fontFamily: FontFamily.script, fontSize: 16, color: '#fff' },
  ...
  sharingTitle:{ fontFamily: FontFamily.script, fontSize: 16, color: INK },
  sharingRow: { flexDirection: 'row', gap: 14, marginTop: 4 },
  sharingText: { fontFamily: FontFamily.marker, fontSize: 10, color: INK },
  ...
  emojiInput:{ fontFamily: FontFamily.ja, fontSize: 12, color: INK, minWidth: 60 },
  emojiLabel:{ fontFamily: FontFamily.marker, fontSize: 9, color: INK + '88' },
  ...
  avatarLetter:{ fontFamily: FontFamily.displayItalic, fontSize: 24, color: '#fff' },
  ageRange:  { fontFamily: FontFamily.marker, fontWeight: '600', fontSize: 9, color: INK + '88', letterSpacing: 1.4 },
  charName:  { fontFamily: FontFamily.script, fontSize: 18, lineHeight: 20, marginTop: 2 },
  charField: { flexDirection: 'row', alignItems: 'center' },
  charFieldKey:{ fontFamily: FontFamily.marker, fontSize: 9, color: INK, fontWeight: '700' },
  charFieldVal:{ fontFamily: FontFamily.script, fontSize: 13 },
  paletteRow:{ flexDirection: 'row', gap: 3, justifyContent: 'center', marginTop: 2 },
  palHint:   { fontFamily: FontFamily.marker, fontSize: 8, color: INK + '60', marginTop: 2 },
  ...
  tropesLabel:{ fontFamily: FontFamily.markerBold, fontWeight: '600', fontSize: 10, color: INK + '88' },
  tropesInput:{ fontFamily: FontFamily.script, fontSize: 13, color: INK, lineHeight: 15, textAlign: 'center', width: '100%' },
  tropesText: { fontFamily: FontFamily.script, fontSize: 13, color: INK, lineHeight: 15, textAlign: 'center' },
  sliderBlock:{ gap: 8 },
});
...
const m = StyleSheet.create({
  ...
  title:       { fontFamily: FontFamily.displayItalic, fontSize: 16, color: INK, marginBottom: Spacing.s4 },
...
const dd = StyleSheet.create({
  ...
  toolTitle:       { fontFamily: FontFamily.script, fontSize: 18, color: INK },
  ...
  toolText:        { fontFamily: FontFamily.marker, fontSize: 11, color: INK },
  ...
  placeholder:     { position: 'absolute', alignSelf: 'center', top: '38%', fontFamily: FontFamily.script, fontSize: 15, color: INK + '55' },
  ...
  iconText:        { fontFamily: FontFamily.marker, fontSize: 10, color: INK },
