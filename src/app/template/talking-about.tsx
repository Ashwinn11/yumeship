...
const s = StyleSheet.create({
  ...
  title:     { fontFamily: FontFamily.displayItalic, fontSize: sf(32), color: INK, letterSpacing: -1, lineHeight: sf(34), marginTop: 2 },
  ...
  subItems:  { marginLeft: 16, fontFamily: FontFamily.script, fontSize: sf(13), color: INK + '88', lineHeight: sf(14), marginTop: 2 },
  ...
  charName:  { fontFamily: FontFamily.script, fontSize: sf(18), lineHeight: sf(20), marginTop: 2 },
  ...
  tropesInput:{ fontFamily: FontFamily.script, fontSize: sf(13), color: INK, lineHeight: sf(15), textAlign: 'center', width: '100%' },
  tropesText: { fontFamily: FontFamily.script, fontSize: sf(13), color: INK, lineHeight: sf(15), textAlign: 'center' },
  sliderBlock:{ gap: 8 },
