...
const y = StyleSheet.create({
  ...
  titleText: { fontFamily: FontFamily.markerBold, fontSize: 9, color: '#fff', textTransform: 'uppercase', letterSpacing: 0.4 },
...
const s = StyleSheet.create({
  ...
  titleText: { fontFamily: FontFamily.displayItalic, fontSize: 22, color: '#fff', letterSpacing: -0.3 },
  titlePill: { alignSelf: 'stretch' },
  hearts: { fontFamily: FontFamily.script, fontSize: 14, color: '#fff', opacity: 0.85, marginTop: 2 },
  row2: { flexDirection: 'row', gap: 8 },
  windowText: { fontFamily: FontFamily.ja, fontSize: 9, color: '#fff', lineHeight: 12, fontWeight: '600' },
  chatInput: { height: 54, textAlignVertical: 'top', fontFamily: FontFamily.ja, fontSize: 9, color: '#fff', backgroundColor: 'transparent', borderColor: 'transparent' },
  ...
  aboutKey: { fontFamily: FontFamily.ja, fontSize: 9, color: '#fff', fontWeight: '700' },
  aboutVal: { flex: 1, height: 14, backgroundColor: 'transparent', borderColor: 'transparent' },
  aboutVal2: { fontFamily: FontFamily.ja, fontSize: 9, color: '#fff' },
  ...
  phoneDots: { fontFamily: FontFamily.markerBold, fontSize: 8, color: '#fff', letterSpacing: 3, marginBottom: 2 },
  ...
  sharingWarn: { fontSize: 12, fontWeight: '700', color: '#fff' },
  sharingLabel: { fontFamily: FontFamily.markerBold, fontSize: 9, color: '#fff', letterSpacing: 0.4 },
  ...
  sharingBoxText: { fontFamily: FontFamily.ja, fontSize: 9, color: Colors.sakuraInk, fontWeight: '700' },
  ...
  sPillText: { fontFamily: FontFamily.ja, fontSize: 7, color: '#fff', fontWeight: '700' },
  sPillTextOn: { color: Colors.sakuraInk },
  freeInput: { height: 50, textAlignVertical: 'top', fontFamily: FontFamily.script, fontSize: 11, backgroundColor: 'transparent', borderColor: 'transparent', color: '#fff' },
  freeText: { fontFamily: FontFamily.script, fontSize: 13, color: '#fff', lineHeight: 15 },
  ...
  songTitle: { fontFamily: FontFamily.script, fontSize: 13, color: '#fff', textAlign: 'center' },
  songPill: { alignSelf: 'stretch' },
  progressRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  timeText: { fontFamily: FontFamily.marker, fontSize: 8, color: '#fff' },
