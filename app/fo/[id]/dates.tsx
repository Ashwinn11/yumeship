    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        <View style={styles.emptyTile}>
          <Text style={styles.watermark}>日</Text>
          ...
          <View style={styles.iconCircle}>
            <Sakura size={42} color={colors.butterDeep} core={colors.vellum} />
          </View>

          <Text style={styles.emptyTitle}>no anniversaries set.</Text>
          <Text style={styles.emptyQuote}>
            "when did you know? mark the day, you'll want to remember."
          </Text>

          <Pressable style={styles.cta}>
            <Heart size={11} color={colors.vellum} />
            <Text style={styles.ctaText}>add a date</Text>
          </Pressable>
        </View>
      </View>
    </SafeAreaView>
